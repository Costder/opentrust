...
class Passport(Base):
    ...
    spec_version: Mapped[str] = mapped_column(String, default="0.1.0")
    protocol_document: Mapped[dict] = mapped_column(json_type(), default=dict)
    ...
    source_formats: Mapped[list[str]] = mapped_column(json_type(), default=list)
